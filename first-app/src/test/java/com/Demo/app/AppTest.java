...
public class AppTest 
{
    ...
    public void mainTest()
    {
        ...
        .withQueueUrl("http://172.17.0.2:4566/000000000000/App1_q")
        ...
        List<Message> messages = sqs.receiveMessage("http://172.17.0.2:4566/000000000000/App1_q").getMessages();
                System.out.println("the massages you recieved are:");
                for (Message m : messages) {
                    output=m.getBody();
                    sqs.deleteMessage("http://172.17.0.2:4566/000000000000/App1_q", m.getReceiptHandle());
                }
